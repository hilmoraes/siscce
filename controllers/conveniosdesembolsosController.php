...
class conveniosdesembolsosController extends Controller{
	...
	public function add(){
		...
		if($c = $conveniosdesembolsos->add($CodConv, $DtDes, $VrRepasseDes, $VrCpDes, $usuario, $CodEmp)){
	...
	public function update(){
		...
		if(isset($_POST['id']) && !empty($_POST['id'])){
			...
			if ($c = $conveniodesembolso->update($id, $DtDes, $VrRepasseDes, $VrCpDes, $usuario, $CodEmp)){
