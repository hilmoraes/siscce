...
class Conveniosdesembolsos extends Model{
	...
	public function add($CodConv, $DtDes, $VrRepasseDes, $VrCpDes, $usuario, $CodEmp){

		$sql = $this->db->query('SET NAMES utf8');
		$sql= $this->db->prepare("INSERT INTO conveniodesembolso (cmpCodConv, cmpDtDes, cmpVrRepasseDes, cmpVrCpDes, usuario, cmpCodEmp) VALUES (:CodConv, :DtDes, :VrRepasseDes, :VrCpDes, :usuario, :CodEmp)");
	...
	public function update($id, $DtDes, $VrRepasseDes, $VrCpDes, $usuario, $CodEmp){

		$sql = $this->db->query('SET NAMES utf8');
		$sql = $this->db->prepare(" UPDATE conveniodesembolso set cmpDtDes = :DtDes, cmpVrRepasseDes = :VrRepasseDes, cmpVrCpDes =:VrCpDes, usuario = :usuario, cmpCodEmp = :CodEmp where cmpCodDes = :cmpCodDes");
