      ...
      <form method="post" action="<?=BASE_URL;?>convenios/update">
        <div class="tab-content">
          <div class="row">
            ...
            <div class="col-md-2">
              <div class="form-group">
                <label col="VrCpConv">Vr. CP:</label>
            ...
            <div class="col-md-2">
              <div class="form-group">
                <label col="AditivoConv">Aditivo:</label>
                  <input type="text" id="AditivoConv" class="form-control input-sm" name="AditivoConv" style="background-color: #ccffff;" value="<?=$convenio['cmpAditivoConv'];?>">
              </div>
            </div>
            ...
            <div class="col-md-2">
              <div class="form-group">
                <label col="VrRepasseAConv">Vr. Repasse:</label>
                  <input type="text" id="VrRepasseAConv" name="VrRepasseAConv" class="VrRepasseAConv form-control" style="display:inline-block; background-color: #ccffff;" value="<?=$convenio['cmpVrRepasseAConv'];?>" onblur="calcConv()">
              </div>
            </div>

            <div class="col-md-2">
              <div class="form-group">
                <label col="VrCpAConv">Vr. CP:</label>
                  <input type="text" id="VrCpAConv" name="VrCpAConv" class="VrCpAConv form-control" style="display:inline-block; background-color: #ccffff;" value="<?=$convenio['cmpVrCpAConv'];?>" onblur="calcConv()">
              </div>
            </div>
