            ...
            <div class="col-md-2">
              <div class="form-group">
                <label col="AditivoConv">Aditivo:</label>
                  <input type="text" id="AditivoConv" class="form-control input-sm" name="AditivoConv" style="background-color: #ccffff;">
              </div>
            </div>
            ...
            <div class="col-md-2">
              <div class="form-group">
                <label col="VrRepasseAConv">Vr. Repasse:</label>
                  <input type="text" id="VrRepasseAConv" name="VrRepasseAConv" value="0" class="VrRepasseAConv form-control" style="display:inline-block; background-color: #ccffff;" onblur="calcConv()">
              </div>
            </div>
            ...
            <div class="col-md-2">
              <div class="form-group">
                <label col="VrCpAConv">Vr. CP:</label>
                  <input type="text" id="VrCpAConv" name="VrCpAConv" value="0" class="VrCpAConv form-control" style="display:inline-block; background-color: #ccffff;" onblur="calcConv()">
              </div>
            </div>
