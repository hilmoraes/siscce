...
<div class="col-md-12">
  <div class="card">
    <div class="card-header">
      <h3 class="card-title" style="color: black;"><b>Relatórios de Gestores</b></h3>
    ...
    <div class="card-body">
      <form method="post" action='<?=BASE_URL;?>gestores/relgestores'>
        <div class="tab-content">
          ...
          <div class="row">
            <div class="col-md-3" style="margin-top: 22px;">
              <a type="button" target="_blank" class="btn btn-primary btn-form" onclick="relGes()">Gerar Relatório</a>
            </div>
          </div>
        </div>
      </form>
