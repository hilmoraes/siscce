            ...
            <div class="col-md-4">
              <div class="form-group">
                <label col="VrRepasseDes">Repasse:</label>
                  <input type="text" id="VrRepasseDes" name="VrRepasseDes" class="VrRepasseDes form-control" style="display:inline-block" value="<?=$conveniodesembolso['cmpVrRepasseDes'];?>">
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label col="VrCpDes">CP:</label>
                  <input type="text" id="VrCpDes" name="VrCpDes" class="VrCpDes form-control" style="display:inline-block" value="<?=$conveniodesembolso['cmpVrCpDes'];?>">
              </div>
            </div>
