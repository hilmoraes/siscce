    ...
    <!-- SELECT2 EXAMPLE -->
      <div class="card card-default col-md-11">
        <div class="card-header">
          <h3 class="card-title" style="color: black;"><b>Contatos da Prefeitura Nº  <?=$id;?></b></h3>
        ...
        <div class="cadCor">
          <form method="post" action='<?=BASE_URL;?>prefeiturassub/add'>
        ...
        <div class="card-body">
          ...
          <table id="example1" class="table table-bordered table-hover">
            ...
            <tbody>
              <?php foreach($prefeiturassub as $list):?>
                <tr style="font-size: 13px;">
                          ...
                          <div class="panel panel-color panel-danger">
                              ...
                              <div class="panel-body">
                                  ...
                                  <div class="modal-footer">
                                      ...
                                      <a href="<?=BASE_URL;?>prefeiturassub/excluir/<?=$id;?>/<?=$list['cmpCodCon'];?>" class="btn btn-danger waves-effect waves-light">Excluir</a>
                                  </div>
                              </div>
                          </div>
                      </div><!-- /.modal-content -->
